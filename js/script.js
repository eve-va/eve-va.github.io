...
class Minesweeper {
  constructor(options = {}) {
    ...
    Object.assign(
      this, {
        ...
        statusMsg: 'Playing', //статус - идет игра/вы проиграл/вы выиграли
        playing: true,
  ...
  render() {
    ...
    //изначально этот контейнер пустой, то есть до этого момента в HTML
    //не было информаци про ряды, клетки и их внутреннее состояние
...
class Cell {
  constructor({
    ...
    y, //координата у - ряд
    value = 0,
    //значение - М-мина, F-отмечена, цифра - количество бомб в смежных клетках
